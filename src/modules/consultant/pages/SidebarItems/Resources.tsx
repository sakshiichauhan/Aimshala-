...
export default function Resources() {
  const primaryTabs = [
    {
      item: "My Resources",
      path: "/consultant/resources/my-resources",
      component: <MyResources />,
    },
    {
      item: "Career Library",
      path: "/consultant/resources/career-library",
      component: <CareerLibrary />,
    },
    {
      item: "Exams",
      path: "/consultant/resources/exams",
      component: <Exams />,
    },
    {
      item: "Scholarship",
      path: "/consultant/resources/scholarship",
      component: <Scholarship />,
    },
    {
      item: "Colleges",
      path: "/consultant/resources/colleges",
      component: <Colleges />,
    },
  ];
  const secondaryTabs = [
    ...
    {
      item: "Future Career Prediction",
      path: "/consultant/resources/career-prediction",
    },
  ];

  const [activePrimaryTab, setActivePrimaryTab] = useState("Career Library");
  const [activeSecondaryTab, setActiveSecondaryTab] =
    useState("Career Cluster");

  // Find the active tab's component
  const activeTabComponent = primaryTabs.find(
    (tab) => tab.item === activePrimaryTab
  )?.component;
      ...
      <div className="max-w-[1360px] h-[53px] inline-flex bg-white border border-gray-300 rounded-[12px] shadow-sm mb-6 mt-2">
        {primaryTabs.map((tab, index) => (
          <button
            ...
            className={`px-8 h-full flex items-center text-xl transition-colors duration-200  ${activePrimaryTab === tab.item
